...
export function Controle() {
    ...
    const [itens, setItens] = useState([
        ...
        { id: 2, descricao: 'Bio Cookie Black', estoque: 32, quantidade: 0 },
        { id: 3, descricao: 'Bio Cookie Black', estoque: 32, quantidade: 0 },
        { id: 4, descricao: 'Bio Cookie Black', estoque: 32, quantidade: 0 }
    ]);
